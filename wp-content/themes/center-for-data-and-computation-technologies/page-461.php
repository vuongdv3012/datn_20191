            ...
            <div class="row">
                        ...
                        <div class="mottinchuan wow fadeIn">
                            ...
                            <div class="noidungtin">
                                ...
                                <div class="thongsotin">
                                    <span class="author">By <?php echo get_the_author(); ?></span> / <span class="comment-count"><?php echo get_comments_number(); ?> Commment</span> / <span><?php echo get_the_category()['0']->name; ?></span>
                                </div>
                                <div class="trichdan">
                                    <?php the_excerpt(); ?>
                                </div>
                ...
                <div class="col-sm-3 wow fadeInRight">
                    ...
                    <div class="widget wow fadeInUp">
                        <h2 class="widget-title">List New</h2>
                        <ul>
                            <?php 
                    ...
                    <div class="widget widget_recent_entries wow fadeInRight">
                        <h2 class="widget-title">Last new</h2>
                        <?php
