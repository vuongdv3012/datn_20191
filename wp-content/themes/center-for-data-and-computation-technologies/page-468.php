...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title mb-60">
                        ...
                        <h3>About us CDCT_@HUST VietNam</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-3" style="margin-left: 1px #777 solid;">
                    <div class="row center"><p style="width: 100%;"><strong>Documents (Download)</strong></p></div>
                    <div class="row">
            ...
            <div class="row justify-content-between align-items-center wow <?php if (($count_about%2)==1){ echo 'fadeInRight'; } else { echo 'fadeInLeft';}?>">
                ...
                <div class="col-md-6 col-lg-6" style="align-self: center!important;">
                    <div class="our_ability_member_text">
                        <h2><?php the_title(); ?></h2>
                        <p><?php the_excerpt(); ?></p>
                        <a href="<?php the_permalink(); ?>" class="btn_2">See more<i class="fa fa-long-arrow-right"></i></a> 
                    </div>
                </div>
                <?php if (($count_about%2)!=1){ ?>
                    <div class="col-md-6 col-lg-6">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4 align-self-center" style="align-self: center!important;">
                    <div class="single_feature_text ">
                        <h2><?php echo get_field('title_div_service_provice'); ?></h2>
                        <p><?php echo get_field('de'); ?></p>
                        <a href="<?php echo get_field('url_div_sp'); ?>" class="btn_2"><?php echo get_field('button_div_sp'); ?></a>
                    </div>
                </div>
    ...
    <div class="center gap fade-down section-heading no-display animated fadeInDown appear">
        <h2 class="main-title"><?php echo get_field('title_div_introduce'); ?></h2>
        <hr>
        <p><?php echo get_field('sologan_div_introduce_my_team'); ?>.</p>
